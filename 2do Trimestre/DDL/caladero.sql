...
--CONSTRAINT CK_barco__matricula CHECK(UPPER(matricula) = matricula)
);
...
CONSTRAINT CK_fecha_cap_per__f_ini CHECK (to_char(fecha_inicial,'dd/mm') < '02/02' OR TO_CHAR(fecha_inicial,'dd/mm') > '28/03'),
CONSTRAINT CK_fecha_cap_per__f_fin CHECK (to_char(fecha_final,'dd/mm') < '02/02' OR TO_CHAR(fecha_final,'dd/mm') > '28/03')
);
...
VALUES ('444LV','CL-AND1',TO_DATE('01/06/2021','DD/MM/YYYY'),TO_DATE('26/07/2021','DD/MM/YYYY'));

INSERT INTO fecha_captura_permitida
VALUES ('957SA','CL-AND1',TO_DATE('3/04/2021','DD/MM/YYYY'),TO_DATE('15/10/2021','DD/MM/YYYY'));

-- Borrar campo armador de barco
